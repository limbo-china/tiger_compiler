...
#line 964 "MyParser.cc"

  switch (yyn) {

case 1:
#line 39 "MyParser.y"
{printf("nlines=%d\n",yyvsp[0].itype); /* show line count */;
    break;}
case 2:
#line 41 "MyParser.y"
...
case 4:
#line 44 "MyParser.y"
{yyval.itype=yyvsp[-1].itype;printf("nchars=%d\n",yyvsp[-1].itype); /* show char count */;
    break;}
case 5:
#line 46 "MyParser.y"
