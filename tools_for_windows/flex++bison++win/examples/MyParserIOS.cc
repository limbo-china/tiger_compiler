...
/*  A Bison++ parser, made from MyParserIOS.y  */
...
#line 393 "MyParserIOS.cc"
const int YY_MyParser_CLASS::EOL_TOKEN=258;
const int YY_MyParser_CLASS::CHAR_TOKEN=259;
...
static const char * const yytname[] = {   "$","error","$illegal.","EOL_TOKEN",
"CHAR_TOKEN","file","lines","line","chars",""
};
#endif
...
-32768,    -2,-32768,    -3,-32768,-32768,-32768,     3,     4,-32768
};
  ...
  *++yyssp = yystate;
  ...
  if (yyssp >= yyss + yystacksize - 1)
	...
	yystacksize = YYMAXDEPTH;
      ...
      yyvs = (YY_MyParser_STYPE *) alloca (yystacksize * sizeof (*yyvsp));
      __yy_bcopy ((char *)yyvs1, (char *)yyvs, size * sizeof (*yyvsp));
#ifdef YY_MyParser_LSP_NEEDED
      yyls = (YY_MyParser_LTYPE *) alloca (yystacksize * sizeof (*yylsp));
...
#line 965 "MyParserIOS.cc"

  switch (yyn) {

case 1:
#line 40 "MyParserIOS.y"
{cout<<"nlines="<<(yyvsp[0].itype)<<endl; /* show line count */;
    break;}
case 2:
#line 42 "MyParserIOS.y"
{yyval.itype=1; /* first line of all */;
    break;}
case 3:
#line 43 "MyParserIOS.y"
{yyval.itype=yyvsp[-1].itype+1;	/* count one more line */;
    break;}
case 4:
#line 45 "MyParserIOS.y"
{yyval.itype=yyvsp[-1].itype;cout<<"nchars="<<(yyvsp[-1].itype)<<endl; /* show char count */;
    break;}
case 5:
#line 47 "MyParserIOS.y"
{ yyval.itype=1;/* first char of line */;
    break;}
case 6:
#line 48 "MyParserIOS.y"
{yyval.itype=yyvsp[-1].itype+1; /* count one more char */;
    break;}
}
...
#line 1197 "MyParserIOS.cc"
#line 50 "MyParserIOS.y"
